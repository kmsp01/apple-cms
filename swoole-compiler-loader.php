...
if (isset($sysInfo['swoole_loader']) and isset($sysInfo['swoole_loader_version'])) {
    ...
    if (!$is_update) {
        echo "<script type='text/javascript'>window.location.href='$the_homeurl/MDadmin.php';</script>";exit;
    }
...
$download_url=[
    'unix'=>[
        'nosafety'=>[
            '5.6'=>'https://compiler.swoole.com/static/loader3.0.0/swoole_loader56.so',
            '7.0'=>'https://compiler.swoole.com/static/loader3.0.0/swoole_loader70.so',
            '7.1'=>'https://compiler.swoole.com/static/loader3.0.0/swoole_loader71.so',
            '7.2'=>'https://api.madouym.net/swoole/swoole_loader72.so',
            '7.3'=>'https://api.madouym.net/swoole/swoole_loader73.so',
            '7.4'=>'https://api.madouym.net/swoole/swoole_loader74.so',
            '8.0'=>'https://api.madouym.net/swoole/swoole_loader80.so',
        ],
        'safety'=>[
            '5.6'=>'https://compiler.swoole.com/static/loader3.0.0/swoole_loader56_zts.so',
            '7.0'=>'https://compiler.swoole.com/static/loader3.0.0/swoole_loader70_zts.so',
            '7.1'=>'https://compiler.swoole.com/static/loader3.0.0/swoole_loader71_zts.so',
            '7.2'=>'https://api.madouym.net/swoole/swoole_loader72_zts.so',
            '7.3'=>'https://api.madouym.net/swoole/swoole_loader73_zts.so',
            '7.4'=>'https://api.madouym.net/swoole/swoole_loader74_zts.so',
            '8.0'=>'https://api.madouym.net/swoole/swoole_loader80_zts.so',
        ]
    ],
    'windows'=>[
        'nosafety'=>[
            '5.6'=>'https://compiler.swoole.com/static/loader3.0.0/swoole_loader56_nzts_x64.dll',
            '7.0'=>'https://compiler.swoole.com/static/loader3.0.0/swoole_loader70_nzts_x64.dll',
            '7.1'=>'https://compiler.swoole.com/static/loader3.0.0/swoole_loader71_nzts_x64.dll',
            '7.2'=>'https://api.madouym.net/swoole/swoole_loader72_nzts_x64.dll',
            '7.3'=>'https://api.madouym.net/swoole/swoole_loader73_nzts_x64.dll',
            '7.4'=>'https://api.madouym.net/swoole/swoole_loader74_nzts_x64.dll',
            '8.0'=>'https://api.madouym.net/swoole/swoole_loader80_nzts_x64.dll',
        ],
        'safety'=>[
            '5.6'=>'https://compiler.swoole.com/static/loader3.0.0/swoole_loader56_zts_x64.dll',
            '7.0'=>'https://compiler.swoole.com/static/loader3.0.0/swoole_loader70_zts_x64.dll',
            '7.1'=>'https://compiler.swoole.com/static/loader3.0.0/swoole_loader71_zts_x64.dll',
            '7.2'=>'https://api.madouym.net/swoole/swoole_loader72_zts_x64.dll',
            '7.3'=>'https://api.madouym.net/swoole/swoole_loader73_zts_x64.dll',
            '7.4'=>'https://api.madouym.net/swoole/swoole_loader74_zts_x64.dll',
            '8.0'=>'https://api.madouym.net/swoole/swoole_loader80_zts_x64.dll',
        ]
    ],
];
...
if ('web' == $env['php']['run_mode']) {
    ...
    <div class="col-12"  style="">
        <h4 style="text-align: center;">环境信息</h4>
        <ul>';
    ...
    if (empty($html_error)) {
        ...
        if ($is_update) {
            $html_body_loader .= '<h4 style="text-align: center;">升级Swoole Loader 扩展</h4><ul style="background: #f1f1f1;">';
        }else{
            $html_body_loader .= '<h4 style="text-align: center;">安装和配置Swoole Loader 扩展</h4><ul style="background: #f1f1f1;">';
        }
        ...
        if ($is_update) {
            ...
            $html_body_loader .= '<p><span class="bold_text">2 - 安装Swoole Loader</span></p><p>将刚才下载的Swoole Loader扩展文件（'.$down_name[1].'）<br>上传到当前PHP的扩展安装目录中：<b style="color: #2196F3;">' . $env['php']['extension_dir'] . '</b></p>';
        }
        ...
        $html_body_loader .= '</p>';
        $html_body_loader .= '<p>4 - 重启PHP或者重启服务器，刷新当前页面即可</p>';
        $html_body_loader .= '</ul></div>';
    }

    // Body footer
    $html_body_footer = '<footer>
    <p style="text-align: center; font-size: 13px;">CopyRight © '. date('Y') . ' <a href="https://madouym.com" target="_blank" class="text-success">MaDouYM</a>  Swoole Compiler 扩展安装助手</p>
  </footer>';
