...
return array(
    ...
    '1' => array('name' => lang('menu/index'), 'icon' => 'xe625', 'sub' => array(
		...
		'37' => array("show"=>1,'name' => 轮播管理, 'controller' => 'carousel',		'action' => 'index'),
        '3701' => array("show"=>0,'name' => '--轮播信息维护', 'controller' => 'carousel',		'action' => 'info'),
        '3702' => array("show"=>0,'name' => '--轮播批量修改', 'controller' => 'carousel',		'action' => 'batch'),
        '3703' => array("show"=>0,'name' => '--轮播删除', 'controller' => 'carousel',		'action' => 'del'),
        '3704' => array("show"=>0,'name' => '--轮播状态', 'controller' => 'carousel',		'action' => 'field'),
