...
<div class="layui-tab">
  ...
  <div class="layui-tab-content">
    ...
    <div class="layui-tab-item">
		...
		<div class="layui-form-item">
          <label class="layui-form-label">播放地址加密</label>
          <div class="layui-input-inline">
            <input type="checkbox" name="player_aes_status" lay-skin="switch" lay-text="开启|关闭" value="1" <?php echo $player['aes']['status']?'checked':'';?>></div>
          <div class="layui-form-mid layui-word-aux">关闭后，不加密，配置说明：网站参数配置-预留参数-加密地址-选择AES，播放器和系统一起配置才生效</div></div>
        <div class="layui-form-item">
    ...
    <div class="layui-tab-item">
		<div class="layui-form-item">
          <label class="layui-form-label">试看模式状态</label>
          <div class="layui-input-inline">
            <input type="checkbox" name="pre_trysee_status" lay-skin="switch" lay-text="开启|关闭" value="1" <?php echo $pre['trysee']['status']?'checked':'';?>></div>
			<div class="layui-form-mid layui-word-aux">仅在PC端有效，关闭则不限制</div>
        </div>
		<div class="layui-form-item">
          <label class="layui-form-label">试看时间</label>
          <div class="layui-input-inline">
            <input type="number" name="pre_trysee_time" placeholder="单位（秒）" value="<?php echo $pre['trysee']['time'];?>" autocomplete="off" class="layui-input"></div>
...
layui.use(['layer', 'form', 'table', 'upload', 'element'], function(){
  ...
  form.on('submit(systemsave)', function(data){
	...
	data.field.player_aes_status = data.field.player_aes_status?data.field.player_aes_status:'0';
	data.field.player_trysee_status = data.field.player_trysee_status?data.field.player_trysee_status:'0';
